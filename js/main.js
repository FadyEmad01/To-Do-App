...
let createobject = () => {
  ...
  if (
    ...
    title.value.trim() == "" ||
    department.value == 0 ||
    Number.isInteger(+cost[0].value) == false ||
    Number.isInteger(+cost[1].value) == false ||
    Number.isInteger(+cost[2].value) == false ||
    Number.isInteger(+cost[3].value) == false ||
    Number.isInteger(+count.value) == false
  ) {
    mood = "create";
